            ...
            <Form className='d-grid'>
                ...
                <Form.Group>
                    <FloatingLabel controlId="floatingInput" label="Activity Name *" className="mb-3">
                        <Form.Control type="text" placeholder="Activity" value={activity.name} onChange={e => setActivity({ ...activity, name: e.target.value })} />
                    </FloatingLabel>
                </Form.Group>
                ...
                <Form.Group>
                    <FloatingLabel controlId="floatingInput" label="Activity Duration (in hours)" className="mb-3">
                        <Form.Control type="text" placeholder="Activity Duration (in hours)" value={activity.duration} onChange={e => setActivity({ ...activity, duration: e.target.value })} />
                    </FloatingLabel>
                </Form.Group>
